...
internal static class SplitsSettingsControl
{
    public static Control Build(SplitsSettings settings)
    {
        ...
        AddPrimitiveSettings(panel, settings);
    ...
    private static void AddPrimitiveSettings(StackPanel panel, SplitsSettings settings)
    {
        panel.Children.Add(AvaloniaSettingsBuilder.Build(settings, "Splits"));
    }
