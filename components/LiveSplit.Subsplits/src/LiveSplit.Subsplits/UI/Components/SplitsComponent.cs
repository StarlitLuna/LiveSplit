...
public class SplitsComponent : IComponent
{
    ...
    private void Prepare(LiveSplitState state)
    {
        ...
        foreach (SplitComponent split in SplitComponents)
        {
            ...
            bool shouldIndent = split.Split == null || split.Split.IconImage != null || Settings.IndentBlankIcons;
    ...
    {
        Settings.Mode = mode;
        return LiveSplit.UI.AvaloniaSettingsBuilder.Build(Settings, "Subsplits");
    }
